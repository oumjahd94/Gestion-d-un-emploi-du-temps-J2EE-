...
<link type="text/css" rel="stylesheet" href="<c:url value="/css/divMod.css" />" /> 
</head>
<body>  
      ...
      <div id="d2">   
	   ...
	   <form  method="post" action=""> 
	      <table border="0" rules="all" width ="85.5%" cellpadding ="10" id="entete1">  
		    <tr >
		        <th> PARAMETRAGE DES MODULES </th>   
		    </tr>   
         </table>       
	     <fieldset class="f1"> <br/>                                                       
              <label for="id">ID de module : </label>   
              <input type="number" id="id" name="f" value="" size="20" maxlength="60" />
              <br />
              <label for="nom">Intitulé de module  : </label>     
              <input type="text" id="nom" name="c" value="" size="20" maxlength="20" />   
              <br/><br /> 
     ...
     <div id="d3">
       ...
       <img src="<c:url value ="/img/module.jpg" />"  width ="100%" height ="100%" />                                </pre>
     </div> <pre>      
     ...
     <div id="d4">
       <table border="0" rules="all" width ="60%" cellpadding ="10" id="entete2">  
		    <tr >
		        <th> LES INFORMATIONS D'UN MODULE </th>     
		    </tr>   
       </table> 
      <fieldset class="f2">
            <form  method="post" action="">    
