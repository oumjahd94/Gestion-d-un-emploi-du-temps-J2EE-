...
<link type="text/css" rel="stylesheet" href="<c:url value="/css/matiere.css" />" />    
</head>
<body>
   ...
   <div id="d1"><img src="<c:url value ="/img/entete.JPG" />" width ="100%" height ="100%" />  </div>  
      <div id="d2">   
	   ...
	   <form  method="post" action=""> 
	      <table border="0" rules="all" width ="85.5%" cellpadding ="10" id="entete1">     
		    <tr >
		        <th> PARAMETRAGE DES MATIERES </th>   
		    </tr>   
         </table>       
	     <fieldset class="f1"> <br/>                                                       
              <label for="id">ID de la matiere : </label>      
     ...
     <div id="d3">
       ...
       <img src="<c:url value ="/img/matiere.jpg" />"  width ="100%" height ="100%" />                                </pre>
     </div> <pre>      
     ...
     <div id="d4">
       <table border="0" rules="all" width ="60%" cellpadding ="10" id="entete2">  
		    <tr >
		        <th> LES INFORMATIONS SUR UNE MATIERE </th>     
		    </tr>   
       </table> 
      <fieldset class="f2">
            <form  method="post" action="">    
