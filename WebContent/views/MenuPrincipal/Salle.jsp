...
<link type="text/css" rel="stylesheet" href="<c:url value="/css/divSal.css" />" /> 
</head>
<body>
   ...
   <div id="d1"><img src="<c:url value ="/img/entete.JPG" />" width ="100%" height ="100%" />  </div>  
      <div id="d2">   
	   ...
	   <form  method="post" action=""> 
	      <table border="0" rules="all" width ="85.5%" cellpadding ="10" id="entete1">  
		    <tr >
		        <th> PARAMETRAGE DES SALLES </th>   
		    </tr>   
         </table>       
	     <fieldset class="f1"> <br/>                                                       
              <label for="id">ID de la salle : </label>    
              <input type="number" id="id" name="f" value="" size="20" maxlength="60" />
              <br />
              <label for="nom">Intitulé de la salle  : </label>     
     ...
     <div id="d3">
       ...
       <img src="<c:url value ="/img/sl.jpg" />"  width ="100%" height ="100%" />                              </pre>
     </div> <pre>      
     ...
     <div id="d4">
       <table border="0" rules="all" width ="60%" cellpadding ="10" id="entete2">  
		    <tr >
		        <th> LES INFORMATIONS D'UNE SALLE </th>     
		    </tr>   
       </table> 
      <fieldset class="f2">
            <form  method="post" action="">    
